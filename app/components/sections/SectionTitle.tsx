        ...
        <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-start gap-2 mt-8">
                ...
                <div className="flex items-center gap-4 pl-3">
                    <div className="marquee-stack__icon hidden md:block" aria-hidden="true">
                        <svg
                        width="100%"
                        height="100%"
                        viewBox="0 0 48 48"
